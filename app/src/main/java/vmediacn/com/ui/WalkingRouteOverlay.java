...
/**
 * Created by DingXingXiang on 2016/4/19.
 */
...
public class WalkingRouteOverlay extends OverlayManager {
    ...
    public final List<OverlayOptions> getOverlayOptions() {
        ...
        if (mRouteLine.getTerminal() != null) {
            ...
            /*View view = LayoutInflater.from(context).inflate(R.layout.navigation_item, null);
            TextView nameTv = (TextView) view.findViewById(R.id.navigation_shopNameId);
            TextView locationTv = (TextView) view.findViewById(R.id.navigation_shopNameId);
